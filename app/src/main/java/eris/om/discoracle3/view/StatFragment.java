 ...
 */
public class StatFragment extends Fragment implements StatFragmentVM.StatFragmentListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        StatFragmentBinding sfbinding = DataBindingUtil.inflate(inflater, R.layout.stat_fragment, container, false);
        sfbinding.setStatFVM(new StatFragmentVM(this));
